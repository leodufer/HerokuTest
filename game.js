var names = ["jhon", "derek", "michael", "rocky", "Ivankov", "OkamaWay", "Elen", "Zoe", "gina", "carol", "vicente", "paola", "fanta", "lalo"];

//constants
var LINE_SEGMENT = 0;
var CHAT_MESSAGE = 1;
var GAME_LOGIC = 2;
//constants for the game logic state
...
function User(socket)
{
	...
	this.id = " " + names[Math.floor(Math.random()*14)];
}
...
Room.prototype.handleOnUserMessage = function(user)
{
	...
	user.socket.on("message", function(message)
	{
		...
		{
			// add the sender info into the message data object
			data.sender = user.id;
		}
...
function GameRoom()
{
	//the current turn of the player index
	this.playerTurn = 0;
